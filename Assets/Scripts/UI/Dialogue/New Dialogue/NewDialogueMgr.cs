...
namespace Cyber
{
    public class NewDialogueMgr : BaseManager<NewDialogueMgr>
    {
        ...
        public void OnTriggerEnter(Collider other, DSDialogue dialogue, Transform NPCTransform)
        {
        ...
        private void Talk(InputAction.CallbackContext call)
        {
            ...
            // 显示对话面板
            UIManager.GetInstance().ShowPanel<NewDialoguePanel>("NewDialoguePanel", E_UI_Layer.System, (panel) =>
            {
                panel.Initialize(dialogue);
            });
        }
