...
namespace HA
{
    ...
    public class HADialogueInspector : Editor
    {
        ...
        private void OnEnable()
        {
            ...
            groupedDialgueProperty = serializedObject.FindProperty("_groupedDialogues");
            startingDialogueOnlyProperty = serializedObject.FindProperty("_startingDialogueOnly");
